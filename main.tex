...
We use datasets from time points $-$1h and $-$8d for the FV, GMC, and IB donors for the summary orthogonality and \partis\ model validation analyses; the +1h, +7d, and +28d datasets for the FV, GMC, and IB donors for the summary orthogonality validation; and the FV -1h dataset for the approximation routine performance analyses in appendices 1 and 2.
...
The \texttt{tcR} package for R includes methods for retrieving and comparing gene usage summaries, computing clonotype diversity indices, and visualizing various repertoire summaries~\cite{Nazarov2015-ok}.
\texttt{VDJtools} is a command line tool which performs similar repertoire summarization, comparison, and visualization tasks~\cite{Shugay2015-ur}.
