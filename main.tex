...
%EM Sometimes Rep-Seq and sometimes rep-seq. I'm happy with either one.
...
This is not necessarily easy, and it is common to simply compare CDR3 length distribution of a repertoire \cite{Miqueu2007-lk,Larimore2012-lo}, leaving the full richness of CDR3 sequence unanalyzed, as well as other interesting aspects of the germline-encoded regions.
...
One can then perform dimension reduction techniques like t-SNE to project repertoires down to a smaller space \cite{Yokota2017-zm}, but these projections lose a lot of information and will have questionable immunological meaning.
...
We would like to facilitate the use of summary statistics of repertoires that are biologically interpretable and capture many different aspects of rep-seq data.
...
Although these patterns would require further exploration in the context of a research paper, we feel that they clearly show that \texttt{sumrep} is finding an interesting signal.
%EM Can we cut the rest of this? I think that we've said enough and the main point is just above.
...
%EM Perhaps this section is part of Methods?
...
%EM I think this should go in the supplement.
\begin{table}
\makebox[\textwidth][c]{
\begin{tabular}{c|c|c|c|c|c}
    %EM igblast's germline database is just IMGT, right?
...
%EM Shouldn't this go before the previous section?
...
%EM I suggest kicking this to supplementary as well.
\begin{figure}
