...
\author[5]{Anna Obraztsova}
\author[1]{Duncan Ralph}
\author[6]{Jason Vander Heiden}
...
\affil[6]{Department of Bioinformatics and Computational Biology, Genentech}
...
To examine the ability of various summary statistics to distinguish among real repertoires, we applied \textt{sumrep} to TCR and BCR datasets performed a multidimensional scaling (MDS) analysis of summary divergences.
...
The \igor~\cite{Marcou2018-du} software features an algorithm for summarizing statistics of the V(D)J rearrangement process, however, the its main focus is on learning the basic model for non-functional T- and B-cell repertoire and it does not provide any built-in methods for comparing inferred models between datasets.
...
The tool can be also used to detect systemic biases between different library preparation protocols and control for batch effects that can confound meta-analysis of Rep-Seq data.
