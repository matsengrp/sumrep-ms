...
%BJO - Hm, that is definitely interesting, although there are some notable exceptions (e.g. basicity, DJ insertion length). I'm not sure if there is enough of a signal to make a sensible comment, but feel free to add something you feel is justified.
...
%BJO - I think so... did you have a specific part in mind?
...
%BJO - Sample sizes are in powers of `e`, but epsilon is in powers of 10. I did it this way since tolerances are often spoken of in powers of 10, whereas using exp(*) for sample sizes may be more arbitrary, but still sensible IMO. I tried to be careful about writing log vs log10 in the plots, but let me know if you find any mistakes.
