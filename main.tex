...
Figures \ref{fig:MasterPlot}, \ref{fig:MasterPlotDouble}, \ref{fig:MasterPlotTriple} show an example outputs of \texttt{plotUnivariateDistributions} computed for one, two, and three datasets, respectively.
