...
These sequences arise by a complex process of random naive cell generation then affinity maturation, leaving considerable hidden structure in the distribution of sequences.
Probabilistic models formalize our understanding of the random process of immune repertoire generation.
One can compare such complex data sets to each other and to generative models using summary statistics: quantities that summarize some aspect of the repertoires.
...
Immune repertoires are large, complex objects.
