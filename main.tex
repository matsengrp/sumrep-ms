...
\end{equation}
This value for a given summary will be negative if \texttt{partis} simulated repertoires look more like their experimental counterparts in terms of this summary than experimental repertoires 
...
Figure \ref{fig:ObsScores} displays the summary scores for the three individuals based on \texttt{partis} simulations.
\begin{figure}
...
Figure \ref{fig:SimScores} displays the LRD scores with respect to 
\begin{figure}
