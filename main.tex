...
%BJO I guess not. My thought was that many studies just look at a few statistics (gene usage, CDR3 length) and this only gives a small snapshot of what's happening because of sparsity. But I can see why the following seems off-topic.
...
%BJO I guess I'm used to lit reviews being in the introduction rather than the discussion, but I trust your judgment here.
...
The D gene usage distribution has an unusual "cross" pattern, although the points in a given leg of the cross still belong to a common donor.
The Hill number divergences also form a cross-like pattern, although a looser one, an
...
There are no convincing trends of clusters by timepoint alone.
Moreover, the level of clustering appears to depend on individual, with clusters belonging to donor Q2 tending to be less contiguous, and clusters belonging to donor S1 being more contiguous.
