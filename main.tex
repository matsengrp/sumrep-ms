...
%EM Similarly, here we take a substantial deviation. I'd suggest a shorter paragraph combining the following two starting with something like "Another application of summary statistics is to compare simulations to sequence data."
