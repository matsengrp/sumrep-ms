...
%BJO - I realize that I alternate between IGoR and "\texttt{igor}" throughout the document, as well as IgBlast vs \igblast. Do you have a preference, Erick? I believe I'm consistent with writing \partis throughout.
...
To address this, we employed lasso multinomial regression by treating the summaries as covariates and dataset identity as the response.
...
To validate this intuition, we can examine distributions of high-ranked, moderately-ranked, and low-ranked summaries for a new set of annotated repertoires.
...
%BJO I went ahead and removed the ecdfs, as I would think the average reader will be more comfortable with a histogram-type plot than an ecdf.
