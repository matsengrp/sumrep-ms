...
It also contains a plotting function for each univariate summary distribution, as well as a master plotting function, \texttt{plotDistributions}, which shows each of these univariate distribution plots in a gridded figure.
Figure \ref{fig:MasterPlot} shows an example output of \texttt{plotDistributions} computed for the \texttt{p\_f1} dataset described in the previous section.
\begin{figure}
...
These results suggest that the user should expect a high degree of accuracy while enjoying a significantly diminished runtime for any reasonable choice of epsilon.
\end{document}
