...
\begin{abstract}
The adaptive immune system generates an incredible diversity of adaptive immune receptors to keep dangerous pathogens at bay.
The DNA sequences coding for these receptors arise by a complex random process of random naive cell generation followed by a series of binding-based filters as well as (in the B cell case) affinity maturation, giving considerable structure to the distribution of sequences.
Probabilistic models formalize our understanding of the random process of immune repertoire generation.
%EM I'd prefer moving the following two sentences to after the comparison using summary stats sentence, describing them as applications. Or perhaps take them out? This abstract is getting long.
